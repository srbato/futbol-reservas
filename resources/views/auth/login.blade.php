<x-guest-layout>
    <div style="text-align:center; margin-bottom:24px;">
        <h1 style="font-size:28px; font-weight:800; color:#e8e8e8; margin:0;">Ingresar</h1>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; flex-wrap:wrap; margin-bottom:20px;">
            <label for="remember_me" style="display:flex; align-items:center; gap:8px; font-size:14px; color:#888; font-weight:400; cursor:pointer;">
                <input
                    id="remember_me"
                    type="checkbox"
                    name="remember"
            ...
            @if (Route::has('password.request'))
                <a
                    ...
                    style="font-size:14px; color:#888; transition:color .2s;"
