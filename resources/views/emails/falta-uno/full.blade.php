...
<head>
  <meta charset="utf-8">
  <title>¡Tu partido está completo!</title>
</head>
<body style="font-family:Arial, Helvetica, sans-serif; background:#f7f7f8; color:#111; padding:24px;">
  <div style="max-width:640px; margin:0 auto; background:#fff; border:1px solid #ececec; border-radius:16px; padding:24px;">
    <h1 style="margin-top:0; color:#22c55e;">🎉 ¡Partido completo!</h1>

    <p>Hola {{ $game->initiator->name }},</p>

    <p>¡Tu partido está lleno! Ya se anotaron todos los jugadores necesarios.</p>
    ...
    <p><strong>Total jugadores:</strong> {{ $game->total_players }}</p>

    <p style="margin-top:16px;">Recordales a los jugadores que deben presentarse en el complejo y abonar su parte directamente ahí.</p>
