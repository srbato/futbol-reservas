...
<head>
  <meta charset="utf-8">
  <title>Un jugador se fue de tu partido</title>
</head>
<body style="font-family:Arial, Helvetica, sans-serif; background:#f7f7f8; color:#111; padding:24px;">
  <div style="max-width:640px; margin:0 auto; background:#fff; border:1px solid #ececec; border-radius:16px; padding:24px;">
    <h1 style="margin-top:0; color:#f59e0b;">🚪 Un jugador se fue</h1>

    <p>Hola {{ $game->initiator->name }},</p>

    <p><strong>{{ $leaver->name }}</strong> se salió del partido.</p>
    ...
    <p><strong>Lugares disponibles ahora:</strong> {{ $game->remainingSlots() }}</p>

    <p style="margin-top:16px; color:#666;">El partido quedó en estado <strong>abierto</strong>. Otros jugadores pueden unirse.</p>
