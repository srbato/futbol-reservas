...
<div style="max-width: 560px; margin: auto; display: grid; gap: 18px;">
  ...
  <div class="page-card" style="text-align:center; padding: 40px 32px;">
    <div style="width:64px; height:64px; border-radius:50%; background:#fef9c3; border:2px solid #fde047; display:flex; align-items:center; justify-content:center; margin:0 auto 20px; font-size:28px;">
      &#9203;
    </div>
  ...
  <div class="page-card" style="background:#f0fdf4; border-color:#bbf7d0;">
