...
<div style="max-width: 560px; margin: auto; display: grid; gap: 18px;">
  ...
  <div class="page-card" style="text-align:center; padding: 40px 32px;">
    <div style="width:64px; height:64px; border-radius:50%; background:rgba(239,68,68,.1); border:2px solid rgba(239,68,68,.25); display:flex; align-items:center; justify-content:center; margin:0 auto 20px; font-size:28px;">
      &#10060;
    </div>
  ...
  <div class="page-card" style="background:rgba(253,224,71,.06); border-color:rgba(253,224,71,.2);">
    <div style="font-size:13px; color:#fbbf24; line-height:1.6;">
